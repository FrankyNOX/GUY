                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                           <a href="{{route("Options.index")}}">Niveaux</a>
                        </li>
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form method="POST" class="form form-vertical" action="{{ route('Niveaux.update',$niveau->id) }}">
                                @csrf
                                @method("PUT")
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <input id="nom" type="text" class="form-control @error('nom') is-invalid @enderror" name="nom" value="{{ $niveau->nom }}" required autocomplete="nom" autofocus>
                                                    @error('nom')
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select id="option_id" class="form-control @error('option_id') is-invalid @enderror" name="option_id">
                                                 <option value="{{$niveau->option->id}}">{{ $niveau->option->nom }}</option>
