            ...
            <div class="col-md-10 offset-1 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Creation d'une UE</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            @include('Commun.flash')
                            <form method="POST" class="form form-vertical" action="{{ route('UE.store') }}">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <input id="Competences_visees" type="text" class="form-control @error('Competences_visees') is-invalid @enderror" name="Competences_visees" value="{{ old('Competences_visees') }}" required autocomplete="Competences_visees" autofocus>
