                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form method="POST" class="form form-vertical" action="{{ route('Filieres.update',$filiere->id) }}">
                                @csrf
                                @method("PUT")
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <input id="nom" type="text" class="form-control @error('nom') is-invalid @enderror" name="nom" value="{{ $filiere->nom }}" required autocomplete="nom" autofocus>
                                                    @error('nom')
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select id="etablissement_id" class="form-control @error('etablissement_id') is-invalid @enderror" name="etablissement_id">
                                                 <option value="{{$filiere->etablissement->id}}">{{ $filiere->etablissement->nom }}</option>
